...
class ExcelParsingError(FileProcessingError):
    ...
    def __init__(self, filename: str, reason: str, sheet_name: Optional[str] = None):
        ...
        super().__init__(filename, f"Excel parsing failed for {context_msg}: {reason}")
...
class DuplicateFileError(FileProcessingError):
    ...
    def __init__(self, filename: str, original_filename: str):
        ...
        super().__init__(filename, f"Duplicate of '{original_filename}'")
...
class HeaderNotFoundError(DataExtractionError):
    ...
    def __init__(self, filename: str, header_label: str, section: str):
        ...
        super().__init__(
            filename, section, f"Header label '{header_label}' not found in worksheet"
        )
...
__all__ = [
    ...
    "QCDataMissingError",
    "DelayDataMissingError",
    "ContainerDataMissingError",
    "HeaderNotFoundError",
    # Validation
    "ValidationError",
