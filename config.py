...
class ApplicationConfig:
    ...
    VERSION: str = (
        "3.1.0"  # Canonical version — imported by api.py and dashboard_api.py
    )
...
class VesselInfoConfig:
    ...
    LABELS: Dict[str, str] = field(
        default_factory=lambda: {
            ...
            "Operator": "Operator:",
            "Berth": "Berth:",
            "Report Date_str": "Date:",
            "ETB_str": "ETB:",
            "ATB_str": "ATB:",
            "ETD_str": "ETD:",
            "Gangway Secured_str": "Gangway secured:",
            ...
            "Lashing Finished_str": "Lashing finished:",
            "ATD_str": "ATD:",
        }
    )

    LABEL_COL_LETTERS: Dict[str, str] = field(
        default_factory=lambda: {
            "Vessel Name": "B",
            "Voyage": "B",
            "Operator": "B",
            ...
            "ATB_str": "L",
            "ETD_str": "H",
            "Gangway Secured_str": "L",
            "Commenced Discharge_str": "B",
            "Completed Discharge_str": "B",
            "Commenced Loading_str": "B",
            "Completed Loading_str": "B",
            "Lashing Finished_str": "B",
            "ATD_str": "B",
        }
    )

    VALUE_COL_LETTERS: Dict[str, str] = field(
        default_factory=lambda: {
            "Vessel Name": "E",
            "Voyage": "E",
            "Operator": "E",
            ...
            "ATB_str": "O",
            "ETD_str": "I",
            "Gangway Secured_str": "O",
            "Commenced Discharge_str": "E",
            "Completed Discharge_str": "E",
            "Commenced Loading_str": "E",
            "Completed Loading_str": "E",
            "Lashing Finished_str": "E",
            "ATD_str": "E",
        }
    )
...
class QCProductivityConfig:
    ...
    HEADER_VARIANTS: Dict[str, List[str]] = field(
        default_factory=lambda: {
            "qc_no": ["qc no.", "qcno", "qc"],
            "start_time": ["start", "start time"],
            "end_time": ["end", "end time"],
            "gross_working_reported": [
                "gross working",
                "grosswork",
                "gross working (hrs)",
            ],
...
class DelayDetailsConfig:
    ...
    QC_COLUMN_BLOCKS: List[Dict[str, str]] = field(
        default_factory=lambda: [
            {
                "name_col_letter": "C",
                "from_col_letter": "C",
            ...
            },
            {
                ...
                "to_col_letter": "L",
                "hours_col_letter": "N",
                "error_remark_col_letter": "O",
            },
        ]
    )

    STOP_CATEGORIES: Dict[str, Dict] = field(
        default_factory=lambda: {
            "Stop-1": {
                "label": "Stop - 1",
                "rows_to_check": 4,
...
class ContainerDetailsConfig:
    ...
    DEFAULT_CATEGORY_BY_COL: Dict[str, str] = field(
        default_factory=lambda: {
            "C": "Full DC",
            "F": "Empty DC",
            "I": "Full RF",
    ...
    CATEGORIES_ORDER: List[str] = field(
        default_factory=lambda: ["Full DC", "Empty DC", "Full RF", "Empty RF"]
    )
    SIZES_ORDER: List[str] = field(default_factory=lambda: ["20", "40", "45"])

    CATEGORY_COL_RANGES: List[tuple] = field(
        default_factory=lambda: [
            ("C", "E", "Full DC"),
            ("F", "H", "Empty DC"),
            ("I", "J", "Full RF"),
...
class DelayErrorConfig:
    ...
    FORCE_MAJEURE_KEYWORDS: List[str] = field(
        default_factory=lambda: ["weather", "bất khả kháng", "thời tiết"]
    )
...
class TDRConfig:
    ...
    search_params: SearchParametersConfig = field(
        default_factory=SearchParametersConfig
    )
    ...
    container_details: ContainerDetailsConfig = field(
        default_factory=ContainerDetailsConfig
    )
...
CONTAINER_SUMMARY_DATA_START_ROW_OFFSET = (
    _config.container_details.DATA_START_ROW_OFFSET
)
MAX_ROWS_TO_READ_CONTAINER_DATA = _config.container_details.MAX_DATA_ROWS
CONTAINER_DEFAULT_CATEGORY_NAMES_BY_START_COL = (
    _config.container_details.DEFAULT_CATEGORY_BY_COL
)
...
try:
    ...
    class Settings(BaseSettings):
        ...
        model_config = SettingsConfigDict(
            env_file=".env", env_prefix="TDR_", extra="ignore"
        )
...
__all__ = [
    ...
    "DATE_FORMAT_OUT",
    "TIME_FORMAT_OUT",
    "VESSEL_SUMMARY_SHEET",
    "QC_PRODUCTIVITY_SHEET",
    "DELAY_DETAILS_SHEET",
    "CONTAINER_SUMMARY_WIDE_SHEET",
    "CONTAINER_SUMMARY_LONG_SHEET",
    "CONTAINER_SUMMARY_LONG_ERROR_SHEET",
    "QC_OPERATOR_PRODUCTIVITY_SHEET",
    "VESSEL_MASTER_FILE",
    "QC_MASTER_FILE",
    "DELAY_MASTER_FILE",
    "CONTAINER_MASTER_WIDE_FILE",
    "CONTAINER_MASTER_LONG_FILE",
    "CONTAINER_MASTER_LONG_ERROR_FILE",
    "QC_OPERATOR_MASTER_FILE",
    "MAX_SEARCH_ROWS_DEFAULT",
    "PARTIAL_MATCH_DEFAULT",
    "MAX_SEARCH_ROWS_VESSEL_INFO",
    "VESSEL_INFO_LABELS",
    "VESSEL_INFO_LABEL_COL_LETTERS",
    "VESSEL_INFO_VALUE_COL_LETTERS",
    "LABEL_BREAK_TIME_SUMMARY_VESSEL",
    "BREAK_TIME_DISCHARGE_COL_LETTER",
    "BREAK_TIME_LOADING_COL_LETTER",
    "LABEL_CRANES_PRODUCTIVITY",
    "MAX_SEARCH_ROWS_QC_HEADER",
    "QC_HEADER_ROW_1_OFFSET",
    "QC_HEADER_ROW_2_OFFSET",
    "QC_DATA_START_ROW_OFFSET_FROM_H1",
    "QC_DATA_START_ROW_OFFSET_FROM_H2",
    "QC_PRODUCTIVITY_HEADER_VARIANTS",
    "QC_IDENTIFIERS_IN_DATA",
    "LABEL_DELAY_TIMES_RECORD",
    "LABEL_QC_NO_IN_DELAY_HEADER",
    "MAX_SEARCH_ROWS_DELAY_HEADER",
    "DELAY_QC_HEADER_ROW_OFFSET",
    "DELAY_QC_IDENTIFIERS_IN_HEADER",
    "DELAY_QC_COLUMN_BLOCKS",
    "DELAY_STOP_CATEGORIES",
    "MAX_SEARCH_ROWS_DELAY_STOP_LABEL",
    "LABEL_TOTAL_STOP_IN_DELAY_TABLE",
    "DELAY_ERROR_CODE_CLASSIFICATION",
    "DELAY_ERROR_FORCE_MAJEURE_KEYWORDS",
    "DELAY_ERROR_UNKNOWN_TYPE",
    "DELAY_DURATION_MISMATCH_THRESHOLD",
    "LABEL_DISCHARGE_LOAD_SUMMARY",
    "MAX_SEARCH_ROWS_CONTAINER_HEADER",
    "CONTAINER_SUMMARY_CAT_ROW_OFFSET",
    "CONTAINER_SUMMARY_SIZE_ROW_OFFSET",
    "CONTAINER_SUMMARY_DATA_START_ROW_OFFSET",
    "MAX_ROWS_TO_READ_CONTAINER_DATA",
    "CONTAINER_DEFAULT_CATEGORY_NAMES_BY_START_COL",
    "CONTAINER_CATEGORIES_IN_ORDER",
    "CONTAINER_SIZES_IN_ORDER",
    "CONTAINER_CATEGORY_COL_RANGES_DEF",
    "CONTAINER_SUMMARY_ROW_TOTAL_CONTS_COL_LETTER",
    "CONTAINER_SUMMARY_ROW_TEUS_COL_LETTER",
    "LABEL_GRAND_TOTAL_IN_CONTAINER_SUMMARY",
    "OP_DISCHARGE",
    "OP_LOADING",
    "OP_SHIFTING_DIS",
    "OP_SHIFTING_LOAD",
    ...
    "OP_GRAND_TOTAL",
    "PORT_ALL",
    "VESSEL_COL_RENAMES_OUTPUT",
    "VESSEL_COLS_OUTPUT_ORDER",
    "VESSEL_DATETIME_COLS_FORMAT",
    "QC_COL_RENAMES_OUTPUT",
    "QC_COLS_OUTPUT_ORDER",
    "QC_TIME_COLS_FORMAT",
    "QC_OPERATOR_COL_RENAMES_OUTPUT",
    "DELAY_DETAILS_COLS_OUTPUT_ORDER",
    "DELAY_DATETIME_COLS_FORMAT",
]
